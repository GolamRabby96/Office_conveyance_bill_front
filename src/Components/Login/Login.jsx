...
const Login = () => {
    ...
    return (
        <section class="h-100 gradient-form loginBackgroupColor">
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1">ADN TELECOM LTD</h4>
                                        </div>
                                        ...
                                        <form onSubmit={handleLogin}>
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                <input onBlur={handleUserForm} type="text" name="user_id" class="form-control" id="user_id"
                                                    placeholder="Enter your Job Id" required/>
                                                <label class="form-label" for="form2Example11">Job ID</label>
                                            </div>

                                            <div data-mdb-input-init class="form-outline mb-4">
                                                <input onChange={handleUserForm} type="password" class="form-control" name="user_password" id="password" placeholder='' autocomplete="off" required />
                                                <label class="form-label" for="form2Example22">Password</label>
                                            </div>

                                            <div class="text-center pt-1 mb-5 pb-1">
                                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3  px-5" type="submit">Log in</button>
                                            </div>
                                ...
                                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                        <h4 class="mb-4">Connecting THE world with the most reliable partner</h4>
